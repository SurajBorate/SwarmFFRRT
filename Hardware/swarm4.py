...
class Swarm():
    ...
    def move(self,):
        ...
        # print(bez_points1)
        bez_points1 = find_bezier_trajectory(waypoints_r1,100,t)
        bez_points2 = find_bezier_trajectory(waypoints_r2,100,t)
        bez_points3 = find_bezier_trajectory(waypoints_r3,100,t)
        bez_points4 = find_bezier_trajectory(waypoints_r4,100,t)
