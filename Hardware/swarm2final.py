...
from cubictraj3 import find_cubic_traj, find_xy_cubic, parameter_estimate#,find_cubic_traj_new, find_xy_cubic_new
...
class Swarm():
    ...
    def move(self,):
        ...
        #ways = np.load('locs1_4robot_ffrrtstar_N.npy') # CG
        ways = np.load('ways_axle_4_Narrow_axle1.npy') # Axle
        print(ways)
        wnn = np.shape(ways)
        wnn = wnn[0]
        ...
        l1=1
        waypoints = np.array([[0,0],[-l1,0],[-l1,l1],[0,l1]])
        ...
        Px1,Py1,Px2,Py2,Px3,Py3,Px4,Py4,Tf = find_cubic_traj(waypoints1, waypoints2, waypoints3, waypoints4, t0, tf, V, dt)
        Tf=Tf[1:]
        # print(Px1)
        # print(waypoints2)
