...
class Swarm():
    ...
    def move(self,):
        ...
        pts3 = np.array([[0,0],[-1,0],[-1,1],[0,1],[0,0],[-1,0]])
        ...
        # waypoints2 = spath2
        # #waypoints2 = pts3
        spath3 = smoothen_movavg(pts3)
        tf3 = parameter_estimate(spath3,0.1)
        waypoints3 = spath3

        # spath4 = smoothen_movavg(waypoints_r4/1000)
        # tf = parameter_estimate(spath4,0.1)
        # waypoints4 = spath4
        ...
        # tf = 30
        tf = tf3
        # Px1,Py1,Tf = find_cubic_traj(waypoints1, t0, tf, 0.1, dt)
        # Px2,Py2,Tf = find_cubic_traj(waypoints2, t0, tf, 0.1, dt)
        # print(Tf)
        Px3,Py3,Tf = find_cubic_traj(waypoints3, t0, tf, 0.1, dt)
        # Px4,Py4,Tf = find_cubic_traj(waypoints4, t0, tf, 0.1, dt)
        # # exit()
        npt = np.shape(Tf)
        npt = npt[0]
